      ...
      <div class="container wow zoomIn">
        <div class="row m-auto">
          <div class="col-md-4 offset-md-4 col-sm-8 offset-sm-2">
            <h3 class="text-center mt-5 mb-3" style="background-color: #578B9D; border-radius: 5px">Admin Login</h3>
            ...
            <form method="post" action="{{route('admin.loggedin')}}">
              ...
              <button type="submit" name="submit" class="btn btn-primary m-auto d-block w-50">Admin Login</button>
            </form>
          </div>
        </div>
      </div>
