...
<body>
  ...
  <div class="page-hero bg-image overlay-dark" style="background-image: url('{{ asset('frontend/assets/img/bg_image_1.jpg')}}'); background-position: bottom; height: 88.6vh;">
    <div class="hero-section">
      <div class="container wow zoomIn">
        <div class="row m-auto">
          <div class="col-md-4 offset-md-4 col-sm-8 offset-sm-2">
            <h3 class="text-center mt-5 mb-3" style="background-color: #578B9D; border-radius: 5px">Patient Login</h3>
            ...
            @endif
            @if (session('msgs'))
                <div class="alert alert-success">{{session('msgs')}}</div>
            @endif
            <form method="post" action="{{route('patient.loggedin')}}">
              @csrf
              ...
              <button type="submit" name="submit" class="btn btn-primary m-auto d-block w-50">Patient Login</button>
            </form>
          </div>
        </div>
      </div>
